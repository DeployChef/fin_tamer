...
mixin _$AccountUpdateRequestDto {
  ...
  $AccountUpdateRequestDtoCopyWith<AccountUpdateRequestDto> get copyWith =>
      _$AccountUpdateRequestDtoCopyWithImpl<AccountUpdateRequestDto>(
          this as AccountUpdateRequestDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AccountUpdateRequestDto &&
...
abstract mixin class $AccountUpdateRequestDtoCopyWith<$Res> {
  factory $AccountUpdateRequestDtoCopyWith(AccountUpdateRequestDto value,
          $Res Function(AccountUpdateRequestDto) _then) =
...
/// @nodoc
@JsonSerializable()
class _AccountUpdateRequestDto extends AccountUpdateRequestDto {
  const _AccountUpdateRequestDto(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AccountUpdateRequestDtoCopyWith<_AccountUpdateRequestDto> get copyWith =>
      __$AccountUpdateRequestDtoCopyWithImpl<_AccountUpdateRequestDto>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AccountUpdateRequestDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AccountUpdateRequestDto &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.balance, balance) || other.balance == balance) &&
            (identical(other.currency, currency) ||
                other.currency == currency));
...
/// @nodoc
abstract mixin class _$AccountUpdateRequestDtoCopyWith<$Res>
    implements $AccountUpdateRequestDtoCopyWith<$Res> {
  factory _$AccountUpdateRequestDtoCopyWith(_AccountUpdateRequestDto value,
          $Res Function(_AccountUpdateRequestDto) _then) =
      __$AccountUpdateRequestDtoCopyWithImpl;
  @override
  @useResult
  $Res call({String name, String balance, String currency});
}
