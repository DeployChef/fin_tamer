...
mixin _$AccountBriefDto {
  ...
  $AccountBriefDtoCopyWith<AccountBriefDto> get copyWith =>
      _$AccountBriefDtoCopyWithImpl<AccountBriefDto>(
          this as AccountBriefDto, _$identity);
...
abstract mixin class $AccountBriefDtoCopyWith<$Res> {
  factory $AccountBriefDtoCopyWith(
          AccountBriefDto value, $Res Function(AccountBriefDto) _then) =
      _$AccountBriefDtoCopyWithImpl;
  @useResult
...
/// @nodoc
@JsonSerializable()
class _AccountBriefDto extends AccountBriefDto {
  const _AccountBriefDto(
      {required this.id,
      required this.name,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AccountBriefDtoCopyWith<_AccountBriefDto> get copyWith =>
      __$AccountBriefDtoCopyWithImpl<_AccountBriefDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AccountBriefDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AccountBriefDtoCopyWith<$Res>
    implements $AccountBriefDtoCopyWith<$Res> {
  factory _$AccountBriefDtoCopyWith(
          _AccountBriefDto value, $Res Function(_AccountBriefDto) _then) =
      __$AccountBriefDtoCopyWithImpl;
  @override
  @useResult
  $Res call({int id, String name, String balance, String currency});
}
