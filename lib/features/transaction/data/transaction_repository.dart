...
class TransactionRepository implements ITransactionRepository {
  ...
  Future<Transaction?> update(TransactionUpdateData data) async {
    try {
      ...
      await remoteDataSource.update(localEntity.apiId, request);
  ...
  Future<Transaction?> getByApiId(int apiId) async {
    try {
      ...
      final account = await accountRepository.getByApiId(entityFromDto.accountApiId);
      final category = await categoryRepository.getByApiId(entityFromDto.categoryApiId);
      if (account == null || category == null) {
