...
String _$historyLocalDataSourceHash() =>
    r'1456387f28da4f51009f0a6120fbfc4c0eaee86b';

/// See also [historyLocalDataSource].
@ProviderFor(historyLocalDataSource)
final historyLocalDataSourceProvider =
    FutureProvider<HistoryLocalDataSource>.internal(
  historyLocalDataSource,
  name: r'historyLocalDataSourceProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$historyLocalDataSourceHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final historyRepositoryProvider = FutureProvider<HistoryRepository>.internal(
  historyRepository,
